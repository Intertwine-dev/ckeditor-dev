...
(function () {
	...
	function loadLang(editor) {
		 ...
		 * @property {String}
		 */
		editor.langCode = editor.config.langCode || "en";
		...
		if (!editor.config.langJSON)
			throw "No langJSON defined";

		editor.lang = CKEDITOR.tools.prototypedCopy(editor.config.langJSON);
